...
class CaseCharge(Base):
    ...
    __table_args__ = (
        ...
        UniqueConstraint("case_id", "charge_id", "filling_date", name="uq_case_charge_occurrence"),
    )

    id: Mapped[int] = mapped_column(primary_key=True)
    case_id: Mapped[int] = mapped_column(ForeignKey("court_cases.id", ondelete="CASCADE"), nullable=False)
    ...
    is_amended: Mapped[bool] = mapped_column(Boolean, default=False, server_default="false")

    # Relationships
    court_case: Mapped["CourtCase"] = relationship("CourtCase", back_populates="charges")
