...
class Charge(Base):
    ...
    __table_args__ = (UniqueConstraint("code_section", name="uq_charge_code_section"),)
    ...
    # Relationships
    case_links: Mapped[List["CaseCharge"]] = relationship(
        "CaseCharge", back_populates="charge"
    )
