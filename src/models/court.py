...
class Court(Base):
    ...
    __table_args__ = (
        UniqueConstraint(
            "qualified_fips", "court_level", "division_type", 
    ...
    court_level: Mapped[str] = mapped_column(String(50), nullable=False)      # e.g., "District", "Circuit"
    division_type: Mapped[str] = mapped_column(String(50), nullable=False)    # e.g., "Criminal", "Civil"
