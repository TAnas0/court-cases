...
if __name__ == "__main__":
    ...
    parser.add_argument('--db-path', default='court_cases.duckdb', help='Path to DuckDB database file.')
    parser.add_argument('--data-dir', default='output', help='Directory containing JSONL files.')
